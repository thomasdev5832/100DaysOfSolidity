...
/*
    🚀 Uniswap V3 enables liquidity providers to narrow down their price ranges for added precision. 
    This means that instead of spreading your assets across a wide price spectrum, you can now define a specific range in which your assets will be utilized. 
    This innovation amplifies fee earnings and capital efficiency, setting the stage for our exploration. 
*/
...
contract UniswapV3Liquidity is IERC721Receiver {
    ...
    function collectAllFees(
        ...
        (amount0, amount1) = nonfungiblePositionManager.collet(params);
    }
